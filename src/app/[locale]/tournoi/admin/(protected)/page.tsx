  ...
  return (
    <div className="p-8 max-w-4xl">
      ...
      <div className="mb-8">
        ...
        <h1 className="font-display text-paper" style={{ fontSize: 48 }}>DASHBOARD</h1>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-0.5 mb-10">
        {stats.map((s) => (
          ...
          >
            <div className="font-display leading-none mb-1" style={{ fontSize: 56, color: s.accent }}>
              {s.value}
            </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-0.5 mb-16">
        {shortcuts.map((s) => (
          <Link
            key={s.href}
            href={s.href}
            className="group flex flex-col gap-1 p-6 transition-colors"
